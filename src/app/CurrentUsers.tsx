...
export default function CurrentUsers() {
    ...
    useEffect(() => {
        (async () => {
            const res = await fetch("https://www.elevon.gg/api/getstats/1160789089/4661160139/605887098/4202932581/2435789930/2151379579/1720936166/3132040251/3405618667/2150346856");
