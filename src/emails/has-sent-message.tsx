import { Tailwind, Body, Container, Img, Html, Text, Column, Row, Section } from "@react-email/components";
        ...
        <Html>
            <Body className='m-0 antialiased bg-blue-950 text-white [font-family:_Trebuchet_MS,Helvetica,sans-serif]'>
                ...
                <Container className='p-4 w-full flex flex-col gap-4'>
                    ...
                    <Text className='w-full bg-gray-500/5 rounded-md border border-white/6'>{message as string}</Text>
                </Container>
            </Body>
        </Html>
    </Tailwind>
